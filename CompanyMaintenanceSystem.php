...
<html>
	<head>
	<!--title><link rel="icon" type="image/png" href="/wamp64/www/Company_Maintenance_System/Header & Footer/Camera.png"/></title-->
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
		...
		<style>
				...
				* {
				...
				.prev:hover, .next:hover , .dot:hover{
		...
		<div class="col-12">
			...
			<div class="row" >
				...
				<div class="col-6" style="height:400px">
					<img src="Home/home7.jpg" style="width:100%"/>
				</div>
