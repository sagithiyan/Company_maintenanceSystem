		...
		<div class="col-12">
			...
			<div class="col-6" align="center">
				<form method="POST" action="loginpage.php">
						...
						<input type="text" name="User_Name" placeholder="Your UserId">
				...
				<br><br><br>
				<p align="right">register <a href="r.php" style="color: blue">Click Here!</a></p>
				<p align="right">Forgot your password? <a href="Forget1.php" style="color: blue">Click Here!</a></p>
			</div>
