<?php  
 ...
 {  
      ...
      {  
           ...
           $query2 = "INSERT INTO login (User_Name, Password,User_Type) VALUES( '$username', '$password','client' )"; 
  ...
  if(isset($_POST["forgetPassword"])){
    ...
    $query = "SELECT * FROM login WHERE email = '$mail'";  
           ...
           {  
              ...
              for ($i = 0; $i < 30; $i++) {
                  $index = mt_rand(0, 61);
                  $randomKey .= $validCharacters[$index];
              }
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:500px;">  
                <h3 align="center">Welcome to cameraix</h3>  
                <br />  
                <?php               
                ...
                <form method="post">  
                     ...
                     <br />  
                     <p align="center"><a href="index.php?action=register">Register</a>&nbsp <a href="index.php?action=forgetPassword">Forget Password?</a></p>  
                </form>  
                <?php       
                }  
...
*/
                ...
                <form method="post">  
                     ...
                     <input type="tel" name="pno"   required  class="form-control" placeholder="Enter your Phone No" />  
                     <br /> 
                     <label>Enter Password</label>  
